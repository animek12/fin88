...
if (!q) return md.sendMessage(from, {text: "Masukkan nomer"},{quoted: md1 })

await md.groupParticipantsUpdate(from, [q + "@s.whatsapp.net"], "add")
md.sendMessage(from, {text: "Sukses"},{quoted: md1 })
} catch(e) {
md.sendMessage(from, {text: "Masukkan nomer, contoh 62xxx, Jika gagal mungkin nomer tersebut baru-baru keluar atau nomer private"},{quoted: md1 }) }
} 
